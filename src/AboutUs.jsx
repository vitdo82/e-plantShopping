    ...
    return (
            <div className="about-us-container">
                ...
                <p className="about-us-content">
                    ...
                    healthier and
                    more sustainable lifestyle. From air-purifying plants to aromatic fragrant ones, we have something
                    for every
                    plant enthusiast.
                </p>
                ...
                <p className="about-us-content">
                    ...
                    every step of
                    the way. Feel free to explore our collection, ask questions, and let us help you find the perfect
                    plant for your
                    home or office.
                </p>
